...
$txt = $_GET['Code']."|".number_format($_GET['CardValue'])."|".$_GET['TrxID']."|".date('H:i:s d/m/y', time())."\n";
fwrite($myfile, $txt);
fclose($myfile);
...
if(isset($_GET['Code'])) {
    ...
    {		
		...
		$data_send = array(
			...
			'pricesvalue' => $info['amount'],

			'value_receive' => $amount_real,

			'card_code' => $info['pin'],

			'card_seri' => $info['serial'],
