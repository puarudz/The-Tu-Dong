                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Lịch Sử Chuyển Tiền Trong Hệ Thống</h4>
                            ...
                            <div class="col-12">
                              ...
                              <tr>
                                  ...
                                  <th>Thời Gian</th>
                                            ...
                                            <tbody>
                                            <?php        
 $sel = mysqli_query($kun->connect_db(), "SELECT * FROM `chuyen_tien` ORDER BY id DESC");
 //$tong = $kun->thong_ke_he_thong('nap_the');
 $tong = mysqli_num_rows(mysqli_query($kun->connect_db(), "SELECT * FROM `chuyen_tien`"));
