...
<?php 
$condition = "WHERE ";
if($_POST['filter_username']) $cond = $condition."`from`='".$_POST['filter_username']."'"; 
?>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h3>Card247.Vn - Lịch Sử Rút Tiền</h3>
                                        <br>
                                        <form action="" method="POST" class="form-inline">
                                            <div class="input-group mb-2 mr-sm-3">
                                              <div class="input-group-prepend">
                                                <div class="input-group-text">Tìm User</div>
                                              </div>
                                              <input type="text" class="form-control" name="filter_username" placeholder="Nhập Tên Username">
                                            </div>
                              ...
                              <tr>
                                  ...
                                  <!--th>Thao Tác</th-->
                                                ...
                                                <tbody>
<?php        
 $sel = mysqli_query($kun->connect_db(), "SELECT * FROM `rut_tien` $cond ORDER BY id DESC LIMIT $start, $kmess");
...
?>
                                  ...
                                  <td><span class="btn btn-<?php echo $btn;?> label-mini"><?php echo $trangthai;?></span></td>
...
?>
    ...
    <?php
if ($tong > $kmess){
echo '<center>' . $kun->phantrang('?act=lsrut_tien&', $start, $tong, $kmess) . '</center>';
}
?>
